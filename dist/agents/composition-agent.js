...
var CompositionalAgent = /** @class */ (function () {
    ...
    CompositionalAgent.prototype.generateStoryboard = function (initialPrompt) {
        return __awaiter(this, void 0, void 0, function () {
            var systemPrompt, model, response, storyboard, storyboardPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        model = this.llm.models.generateContent({ model: "gemini-1.5-pro" });
                    ...
                    case 1:
                        response = _a.sent();
                        storyboard = (0, utils_1.safeJsonParse)(response.response.text());
...
//# sourceMappingURL=composition-agent.js.map